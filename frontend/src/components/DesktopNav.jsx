...
const DesktopNav = () => {
    ...
    return (
        <div className="hidden z-10 justify-evenly gap-x-6 border-t border-gray-300 px-4 bg-white pt-2 w-full text-xs lg:border-t-0 lg:border-b lg:flex lg:justify-start lg:gap-x-10 lg:px-10 lg:py-3">
            <NavLink
                to="" end
                className={({ isActive }) =>
                    isActive
